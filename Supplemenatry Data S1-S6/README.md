...
Supplemental Data S4. Correlation between BovCADD and FAETH scores across score percentile bins. (XLSX)
Supplemental Data S5. High-burden genes identified at thresholds of more than 20, 25, 30 and 35 rare deleterious variants per gene. (XLSX)
Supplemental Data S6. Sample lists for the 1000 Bull Genomes Project, BovCADD training data, OPTIBOV project, and the gene-based burden analyses. (XLSX)
